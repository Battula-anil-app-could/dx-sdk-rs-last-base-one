...
/// i.e. the framework/Arwen functionality for accepting EGLD and DCT payments.
...
pub trait PayableFeatures {
    ...
    fn payable_any_2(
        ...
        let token = self.call_value().egld_or_single_dct().token_identifier;
        (payment, token).into()
    }
    ...
    #[endpoint]
    #[payable("EGLD")]
    fn payable_egld_4(&self) -> MultiValue2<BigUint, EgldOrDctTokenIdentifier> {
