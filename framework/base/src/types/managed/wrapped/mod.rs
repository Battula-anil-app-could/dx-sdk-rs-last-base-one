mod egld_or_dct_token_identifier;
mod egld_or_dct_token_payment;
mod egld_or_multi_dct_payment;
...
pub use egld_or_dct_token_identifier::EgldOrDctTokenIdentifier;
pub use egld_or_dct_token_payment::EgldOrDctTokenPayment;
pub use egld_or_multi_dct_payment::EgldOrMultiDctPayment;
